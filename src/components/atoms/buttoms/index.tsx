...
const ButtonPrincipal: React.FC<ButtonPrincipalProps> = ({ onClick }) => {
  return ( 
    <button className='bg-primary w-[156px] h-[51px] rounded-md top-[390px] left-[69px] absolute' onClick={onClick}>
